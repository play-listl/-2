document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'The Simpsons': [20, 12, 8, 6, 4, 3, 2, 0],
        'Law & Order: SVU': [16, 16, 11, 7, 5, 4, 2, 1],
        'Greys Anatomy': [12, 12, 14, 9, 7, 5, 3, 2],
        'Friends': [10, 10, 11, 12, 8, 6, 4, 4],
        'The Office': [8, 8, 8, 9, 11, 8, 5, 5],
        'Game of Thrones': [6, 6, 7, 7, 8, 10, 7, 5],
        'Breaking Bad': [5, 5, 5, 6, 7, 9, 9, 7],
        'Stranger Things': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'The Simpsons', year: '34 seasons' },
        { city: 'Law & Order: SVU', year: '24 seasons' },
        { city: 'Greys Anatomy', year: '20 seasons' },
        { city: 'Friends', year: '10 seasons' },
        { city: 'The Office', year: '9 seasons' },
        { city: 'Game of Thrones', year: '8 seasons' },
        { city: 'Breaking Bad', year: '5 seasons' },
        { city: 'Stranger Things', year: '4 seasons' }
    ];
